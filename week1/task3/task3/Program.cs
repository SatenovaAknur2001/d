...
namespace ak
{
    class Program
    {
        static void clon()//creating method
        {
            ...
            string[] massiv = a.Split(' ');//input every number seperate string,sorted with helps split(split separates value every space)
            string[] massiv2 = new string[massiv.Length + massiv.Length];// create new array for repeating numbers
